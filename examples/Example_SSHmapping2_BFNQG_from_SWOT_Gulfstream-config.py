...
plot_time_step = timedelta(days=999)  
...
file_boundary_conditions = '../data/Extra_data/2020a_SSH_mapping_NATL60_DUACS_swot_en_j1_tpn_g2.nc'
...
path_save = f'../data/Surf_fields/ssh_reconstruction_bfnqg_'+init_date.strftime("%Y-%m-%d")+'-'+final_date.strftime("%Y-%m-%d")+'_swot0'
