...
class Model_qg1l:
    ...
    def __init__(self,config,State): 
        ...
        SourceFileLoader("modgrid", 
                         "../pydssa/func_ssh_mapping/func_ssh_mapping_bfnqg/model_qg1l/modgrid.py").load_module() 
        SourceFileLoader("moddyn", 
                         "../pydssa/func_ssh_mapping/func_ssh_mapping_bfnqg/model_qg1l/moddyn.py").load_module()     
        SourceFileLoader("modelliptic", 
                         "../pydssa/func_ssh_mapping/func_ssh_mapping_bfnqg/model_qg1l/modelliptic.py").load_module()     
        self.qgsw = SourceFileLoader("qgsw", 
                                 "../pydssa/func_ssh_mapping/func_ssh_mapping_bfnqg/model_qg1l/qgsw.py").load_module() 
